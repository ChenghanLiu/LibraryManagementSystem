        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='tushu'">
                    <el-form-item class="select" v-if="type!='info'"  label="图书信息" prop="tushuId">
                        <el-select v-model="ruleForm.tushuId" :disabled="ro.tushuId" filterable placeholder="请选择图书信息" @change="tushuChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='tushu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="图书编号" prop="tushuUuidNumber">
                        <el-input v-model="tushuForm.tushuUuidNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='tushu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="图书标题" prop="tushuName">
                        <el-input v-model="tushuForm.tushuName"
                                  placeholder="图书标题" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='tushu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="图书作者" prop="tushuZuozhe">
                        <el-input v-model="tushuForm.tushuZuozhe"
                                  placeholder="图书作者" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='tushu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="图书出版社" prop="chubansheValue">
                        <el-input v-model="tushuForm.chubansheValue"
                                  placeholder="图书出版社" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='tushu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="所在书架" prop="shujiaValue">
                        <el-input v-model="tushuForm.shujiaValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='tushu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="图书数量" prop="tushuNumber">
                        <el-input v-model="tushuForm.tushuNumber"
                                  placeholder="图书数量" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="借阅时间（天）" prop="tushujieyueShijian">
                       <el-input v-model="ruleForm.tushujieyueShijian"
                                 placeholder="借阅时间（天）" clearable  :readonly="ro.tushujieyueShijian"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="借阅时间（天）" prop="tushujieyueShijian">
                           <el-input v-model="ruleForm.tushujieyueShijian"
                                     placeholder="借阅时间（天）" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="借阅状态" prop="tushujieyueTypes">
                        <el-select v-model="ruleForm.tushujieyueTypes" :disabled="ro.tushujieyueTypes" placeholder="请选择借阅状态">
                            <el-option
                                v-for="(item,index) in tushujieyueTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="借阅状态" prop="tushujieyueValue">
                        <el-input v-model="ruleForm.tushujieyueValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    tushuId: false,
                    yonghuId: false,
                    tushujieyueShijian: false,
                    tushujieyueTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    tushuId: '',
                ...
                rules: {
                   ...
                   tushujieyueShijian: [
                              { required: true, message: '借阅时间（天）不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=tushujieyue_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.tushujieyueTypesOptions = data.data.list;
                    }
                });
